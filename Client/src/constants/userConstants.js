...
export const USER_GET_BY_USERTYPETEACHER_GET_REQUEST =
  'USER_GET_BY_USERTYPETEACHER_GET_REQUEST';
export const USER_GET_BY_USERTYPETEACHER_GET_SUCCESS =
  'USER_GET_BY_USERTYPETEACHER_GET_SUCCESS';
export const USER_GET_BY_USERTYPETEACHER_GET_FAIL =
  'USER_GET_BY_USERTYPETEACHER_GET_FAIL';

export const USER_GET_BY_USERTYPEST_GET_REQUEST =
  'USER_GET_BY_USERTYPEST_GET_REQUEST';
export const USER_GET_BY_USERTYPEST_GET_SUCCESS =
  'USER_GET_BY_USERTYPEST_GET_SUCCESS';
export const USER_GET_BY_USERTYPEST_GET_FAIL =
