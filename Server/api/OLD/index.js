...
router.post('/api/user/user_meta_data', userController.user_meta_data);

router.post('/api/add/designation', designationController.addDesignation);
...
//Company starts
router.post('/api/add/comapnydata', CompanyController.addCompanyInfo);

router.post('/api/add/comapnymetadata', CompanyController.addCompanyMetaInfo);
//Company Ends
